...
namespace ConsoleChat
{
    class Client
    {
        ...
        public Client(string name)
        {
            ...
            NetBroadcastAddress = new IPAddress(broad);
        ...
        private void SendUdpMessage(byte type, string name)
        {
            UdpClient sender = new UdpClient(); 
            IPEndPoint endPoint = new IPEndPoint(NetBroadcastAddress, UdpPort);
            try
            {
                UdpMessage msg = new UdpMessage(type, name);
                            ...
                            case 1:
                                {
                                    ...
                                    try                 //новый пользователь в сети
                                    {
                                        ...
                                        client.Connect(remoteIp.Address.ToString(), TcpPort);
